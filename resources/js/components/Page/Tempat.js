...
const Tempat = () => {
    ...
    if (!data) {
            ...
            <div>
                ...
                <section className="review-section">
      ...
      </Button>:<div style={{fontStyle:"italic",fontWeight:"bold",color:"rgb(5, 38, 146)",fontSize:"1rem"}}>Ayo login untuk mulai sharing !</div>}
                    ...
                    {dataReview && dataReview.length > 0 ?
                        ...
                        : dataReview && dataReview.length === 0 ? <div style={{ margin: "4vh 0", fontSize: "1.5rem", color: "gray" }}>Belum ada yang sharing disini, Yuk jadi yang pertama!</div> : tokenStatus ? <Skeleton active />:<div style={{ margin: "4vh 0", fontSize: "1.5rem", color: "gray" }}>Belum ada yang sharing disini, Yuk jadi yang pertama!</div>}
